namespace Entitas {
    ...
    /// [SingleEntity]: the code generator will generate additional methods for
    /// the pool to ensure that only one entity with this component exists.
    /// E.g. pool.isAnimating = true or pool.SetResources();
    /// [MyPoolName, MyOtherPoolName]: You can make this component to be
    /// available only in the specified pools.
