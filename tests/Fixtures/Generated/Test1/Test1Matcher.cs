...
public sealed partial class Test1Matcher {
    ...
    public static Entitas.IAllOfMatcher<Test1Entity> AllOf(params int[] indexes) {
        return Entitas.Matcher<Test1Entity>.AllOf(indexes);
    }
    ...
    public static Entitas.IAnyOfMatcher<Test1Entity> AnyOf(params int[] indexes) {
          return Entitas.Matcher<Test1Entity>.AnyOf(indexes);
    }
