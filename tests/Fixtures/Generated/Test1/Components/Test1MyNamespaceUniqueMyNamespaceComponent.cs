...
public partial class Test1Context {
    ...
    public Test1Entity myNamespaceUniqueMyNamespaceEntity { get { return GetGroup(Test1Matcher.MyNamespaceUniqueMyNamespace).GetSingleEntity(); } }
    ...
    public Test1Entity SetMyNamespaceUniqueMyNamespace(string newValue) {
...
public partial class Test1Entity {
    ...
    public My.Namespace.UniqueMyNamespaceComponent myNamespaceUniqueMyNamespace { get { return (My.Namespace.UniqueMyNamespaceComponent)GetComponent(Test1ComponentsLookup.MyNamespaceUniqueMyNamespace); } }
    public bool hasMyNamespaceUniqueMyNamespace { get { return HasComponent(Test1ComponentsLookup.MyNamespaceUniqueMyNamespace); } }

    public void AddMyNamespaceUniqueMyNamespace(string newValue) {
        var index = Test1ComponentsLookup.MyNamespaceUniqueMyNamespace;
    ...
    public void RemoveMyNamespaceUniqueMyNamespace() {
        RemoveComponent(Test1ComponentsLookup.MyNamespaceUniqueMyNamespace);
    }
}
...
public sealed partial class Test1Matcher {
    ...
    static Entitas.IMatcher<Test1Entity> _matcherMyNamespaceUniqueMyNamespace;

    public static Entitas.IMatcher<Test1Entity> MyNamespaceUniqueMyNamespace {
        get {
            if (_matcherMyNamespaceUniqueMyNamespace == null) {
                var matcher = (Entitas.Matcher<Test1Entity>)Entitas.Matcher<Test1Entity>.AllOf(Test1ComponentsLookup.MyNamespaceUniqueMyNamespace);
