//HintName: MyFeature.AnotherNamespacedComponent.MyApp.Main.Matcher.g.cs
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace MyFeature
{
public sealed class MyAppMainAnotherNamespacedMatcher
{
    static global::Entitas.IMatcher<Entity> _matcher;

    public static global::Entitas.IMatcher<Entity> AnotherNamespaced
    {
        get
        {
            if (_matcher == null)
