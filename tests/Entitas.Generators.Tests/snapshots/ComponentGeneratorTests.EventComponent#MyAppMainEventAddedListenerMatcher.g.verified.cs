//HintName: MyAppMainEventAddedListenerMatcher.g.cs
//------------------------------------------------------------------------------
// <auto-generated>
...
public sealed class MyAppMainEventAddedListenerMatcher
{
    static global::Entitas.IMatcher<Entity> _matcher;

    public static global::Entitas.IMatcher<Entity> EventAddedListener
    {
        get
        {
            if (_matcher == null)
