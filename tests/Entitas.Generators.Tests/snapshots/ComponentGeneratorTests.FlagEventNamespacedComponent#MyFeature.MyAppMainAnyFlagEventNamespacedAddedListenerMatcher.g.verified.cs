//HintName: MyFeature.MyAppMainAnyFlagEventNamespacedAddedListenerMatcher.g.cs
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace MyFeature
{
public sealed class MyAppMainAnyFlagEventNamespacedAddedListenerMatcher
{
    static global::Entitas.IMatcher<Entity> _matcher;

    public static global::Entitas.IMatcher<Entity> AnyFlagEventNamespacedAddedListener
    {
        get
        {
            if (_matcher == null)
