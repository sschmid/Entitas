//HintName: MyAppMainAnyEventAddedListenerMatcher.g.cs
//------------------------------------------------------------------------------
// <auto-generated>
...
public sealed class MyAppMainAnyEventAddedListenerMatcher
{
    static global::Entitas.IMatcher<Entity> _matcher;

    public static global::Entitas.IMatcher<Entity> AnyEventAddedListener
    {
        get
        {
            if (_matcher == null)
