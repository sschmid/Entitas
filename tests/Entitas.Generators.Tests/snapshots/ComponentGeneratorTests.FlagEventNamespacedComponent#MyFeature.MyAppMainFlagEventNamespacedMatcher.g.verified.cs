//HintName: MyFeature.MyAppMainFlagEventNamespacedMatcher.g.cs
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace MyFeature
{
public sealed class MyAppMainFlagEventNamespacedMatcher
{
    static global::Entitas.IMatcher<Entity> _matcher;

    public static global::Entitas.IMatcher<Entity> FlagEventNamespaced
    {
        get
        {
            if (_matcher == null)
