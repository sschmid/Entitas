//HintName: MyFeature.MyAppMainEventNamespacedRemovedListenerMatcher.g.cs
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace MyFeature
{
public sealed class MyAppMainEventNamespacedRemovedListenerMatcher
{
    static global::Entitas.IMatcher<Entity> _matcher;

    public static global::Entitas.IMatcher<Entity> EventNamespacedRemovedListener
    {
        get
        {
            if (_matcher == null)
