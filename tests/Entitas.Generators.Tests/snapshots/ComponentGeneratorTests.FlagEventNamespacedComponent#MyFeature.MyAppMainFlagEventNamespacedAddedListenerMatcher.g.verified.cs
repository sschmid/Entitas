//HintName: MyFeature.MyAppMainFlagEventNamespacedAddedListenerMatcher.g.cs
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace MyFeature
{
public sealed class MyAppMainFlagEventNamespacedAddedListenerMatcher
{
    static global::Entitas.IMatcher<Entity> _matcher;

    public static global::Entitas.IMatcher<Entity> FlagEventNamespacedAddedListener
    {
        get
        {
            if (_matcher == null)
