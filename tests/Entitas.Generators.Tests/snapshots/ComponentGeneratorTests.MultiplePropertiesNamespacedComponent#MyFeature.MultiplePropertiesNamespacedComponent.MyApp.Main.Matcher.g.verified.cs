//HintName: MyFeature.MultiplePropertiesNamespacedComponent.MyApp.Main.Matcher.g.cs
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace MyFeature
{
public sealed class MyAppMainMultiplePropertiesNamespacedMatcher
{
    static global::Entitas.IMatcher<Entity> _matcher;

    public static global::Entitas.IMatcher<Entity> MultiplePropertiesNamespaced
    {
        get
        {
            if (_matcher == null)
