//HintName: MyFeature.ReservedKeywordFieldsNamespacedComponent.MyApp.Main.Matcher.g.cs
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace MyFeature
{
public sealed class MyAppMainReservedKeywordFieldsNamespacedMatcher
{
    static global::Entitas.IMatcher<Entity> _matcher;

    public static global::Entitas.IMatcher<Entity> ReservedKeywordFieldsNamespaced
    {
        get
        {
            if (_matcher == null)
