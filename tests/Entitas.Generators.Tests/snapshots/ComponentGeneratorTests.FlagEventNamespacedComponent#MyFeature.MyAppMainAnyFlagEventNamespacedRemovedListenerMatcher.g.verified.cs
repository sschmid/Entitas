//HintName: MyFeature.MyAppMainAnyFlagEventNamespacedRemovedListenerMatcher.g.cs
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace MyFeature
{
public sealed class MyAppMainAnyFlagEventNamespacedRemovedListenerMatcher
{
    static global::Entitas.IMatcher<Entity> _matcher;

    public static global::Entitas.IMatcher<Entity> AnyFlagEventNamespacedRemovedListener
    {
        get
        {
            if (_matcher == null)
