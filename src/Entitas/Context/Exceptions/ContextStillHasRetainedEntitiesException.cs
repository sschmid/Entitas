...
namespace Entitas
{
    ...
    {
        public ContextStillHasRetainedEntitiesException(IContext context, IEnumerable<IEntity> entities) :
        ...
        static string EntitiesToString(IEnumerable<IEntity> entities) =>
