...
namespace Entitas.Migration
{
    public class M0360_2 : IMigration
    {
        ...
        string migrateTrigger(string fileContent)
        {
            ...
            if (groupEvent == "Added")
                fileContent = Regex.Replace(fileContent, triggerPattern, _ => string.Format(triggerReplacement, oldMatcher));
            else
                fileContent = Regex.Replace(fileContent, triggerPattern, _ => string.Format(triggerEventReplacement, oldMatcher, groupEvent));
