...
public partial class GameContext {
    ...
    public GameEntity SetISomeInterface(ISomeInterface newValue) {
        if(hasISomeInterface) {
            throw new Entitas.Core.EntitasException("Could not set ISomeInterface!\n" + this + " already has an entity with ISomeInterfaceComponent!",
...
public sealed partial class GameMatcher {
    ...
    static Entitas.Core.IMatcher<GameEntity> _matcherISomeInterface;

    public static Entitas.Core.IMatcher<GameEntity> ISomeInterface {
        get {
