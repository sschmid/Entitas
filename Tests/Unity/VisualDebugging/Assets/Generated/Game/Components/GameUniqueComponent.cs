...
public partial class GameContext {
    ...
    public GameEntity SetUnique(string newValue) {
        if(hasUnique) {
            throw new Entitas.Core.EntitasException("Could not set Unique!\n" + this + " already has an entity with UniqueComponent!",
...
public sealed partial class GameMatcher {
    ...
    static Entitas.Core.IMatcher<GameEntity> _matcherUnique;

    public static Entitas.Core.IMatcher<GameEntity> Unique {
        get {
