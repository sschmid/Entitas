...
public sealed partial class TestMatcher {
    ...
    static Entitas.Core.IMatcher<TestEntity> _matcherComponentWithFieldsAndProperties;

    public static Entitas.Core.IMatcher<TestEntity> ComponentWithFieldsAndProperties {
        get {
