...
public sealed partial class TestMatcher {
    ...
    static Entitas.Core.IMatcher<TestEntity> _matcherClassWithEntitIndexAttribute;

    public static Entitas.Core.IMatcher<TestEntity> ClassWithEntitIndexAttribute {
        get {
