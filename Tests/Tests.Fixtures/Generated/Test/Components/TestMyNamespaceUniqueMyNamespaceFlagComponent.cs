...
public sealed partial class TestMatcher {
    ...
    static Entitas.Core.IMatcher<TestEntity> _matcherMyNamespaceUniqueMyNamespaceFlag;

    public static Entitas.Core.IMatcher<TestEntity> MyNamespaceUniqueMyNamespaceFlag {
        get {
