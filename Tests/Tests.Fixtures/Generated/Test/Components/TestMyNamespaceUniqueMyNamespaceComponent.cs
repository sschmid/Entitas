...
public partial class TestContext {
    ...
    public TestEntity SetMyNamespaceUniqueMyNamespace(string newValue) {
        if(hasMyNamespaceUniqueMyNamespace) {
            throw new Entitas.Core.EntitasException("Could not set MyNamespaceUniqueMyNamespace!\n" + this + " already has an entity with My.Namespace.UniqueMyNamespaceComponent!",
...
public sealed partial class TestMatcher {
    ...
    static Entitas.Core.IMatcher<TestEntity> _matcherMyNamespaceUniqueMyNamespace;

    public static Entitas.Core.IMatcher<TestEntity> MyNamespaceUniqueMyNamespace {
        get {
