...
public sealed class TestEventToGenerateEventSystem : Entitas.ReactiveSystem<TestEntity> {
    ...
    readonly System.Collections.Generic.List<ITestEventToGenerateListener> _listenerBuffer;

    public TestEventToGenerateEventSystem(Contexts contexts) : base(contexts.test) {
        _listeners = contexts.test.GetGroup(TestMatcher.TestEventToGenerateListener);
        _entityBuffer = new System.Collections.Generic.List<TestEntity>();
        _listenerBuffer = new System.Collections.Generic.List<ITestEventToGenerateListener>();
    }
    ...
    protected override void Execute(System.Collections.Generic.List<TestEntity> entities) {
        foreach (var e in entities) {
            ...
            foreach (var listenerEntity in _listeners.GetEntities(_entityBuffer)) {
                ...
                _listenerBuffer.AddRange(listenerEntity.testEventToGenerateListener.value);
