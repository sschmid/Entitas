...
//------------------------------------------------------------------------------
namespace Entitas {
    public interface IDefaultPoolEntity : IEntity {
        DefaultPoolComponent defaultPool { get; }
        bool hasDefaultPool { get; }
        IDefaultPoolEntity AddDefaultPool();
        IDefaultPoolEntity ReplaceDefaultPool();
        IDefaultPoolEntity RemoveDefaultPool();
    }
