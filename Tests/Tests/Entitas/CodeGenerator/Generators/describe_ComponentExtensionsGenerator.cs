...
class describe_ComponentExtensionsGenerator : nspec {
    ...
    void when_generating() {
        ...
        it["component for custom context"] = () => generates<OtherPoolComponent>();
        ...
        it["generates component with default context"] = () => generates<DefaultPoolComponent>();
        it["generates component with default context and others"] = () => generates<MultiplePoolAndDefaultPoolComponent>();
